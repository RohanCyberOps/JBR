package Applications.SystemApplications;
...
public class AttendanceManagementSystemGUI extends JFrame {
    ...
    private void connectToDatabase() {
        try {
            ...
            String user = "root@localhost"; // Replace with your MySQL username
            String password = "Rohan15@"; // Replace with your MySQL password
